...
def main():
    ...
    try:
        # swap: CHI re-trades its stake to MIA
        ...
        # protected: the conveying team re-trades its band
        ...
        # binary: a chain-referenced team re-trades its stake
        registry.save_registry(registry._empty())
        ...
        check("binary retrade: worse_to updated to POR",
              registry.load_registry()["binary_chains"]["c1"][0]["worse_to"] == "POR")
